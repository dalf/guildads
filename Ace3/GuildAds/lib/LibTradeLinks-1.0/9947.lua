...
local SpellList = {
	...
	local extraSpells = {
		...
		[trade.SKILL_ENCHANTING] = { 7411,7412,7413,13920,28029,51313 },
		[trade.SKILL_LEATHERWORKING] = { 2108,3104,3811,10656,10660,10658,10662,32549,51302 },
		[trade.SKILL_COOKING] = { 2550,3102,3413,18260,33359,51296 },
		[trade.SKILL_JEWELCRAFTING] = { 25229,25230,28894,28895,28897,51311 },
		[trade.SKILL_INSCRIPTION] = { 45357,45358,45359,45360,45361,45363 },
		[trade.SKILL_ENGINEERING] = { 4036,4037,4038,12656,20222,20219,30350,51306 },
		[trade.SKILL_BLACKSMITHING] = { 2018,3100,3538,9785,9788,9787,17039,17040,17041,29844,51300 },
		[trade.SKILL_ALCHEMY] = { 2259,3101,3464,11611,28596,28677,28675,28672,51304 },
		[trade.SKILL_FIRSTAID] = { 3273,3274,7924,10846,27028,45542,10846 },
		[trade.SKILL_MINING] = { 2656 },
	}

	for k, v in pairs(SpellList) do
		local craft, list
		for c,l in pairs(extraSpells) do
			for i = 1, #l do
				if l[i] == k then
					craft = c
					list = l
		...
		if craft and list and v then
			trade:AddData(build, craft, list, v)
		end
	end
